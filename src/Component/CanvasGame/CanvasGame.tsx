...
//   constructor(props: ClassComponentProps, ctx: CanvasRenderingContext2D, selectedBird: string) {
...
//         <img src={ProjectImages[`${selectedBird}_UP`]} />
//       </div>
...
//       <h3>Select Bird</h3>
//       <button onClick={() => setSelectedBird("BIRD1")}>
//         <img src={ProjectImages.BIRD1_MID} width={40} />
//       </button>
//       <button onClick={() => setSelectedBird("BIRD2")}>
//         <img src={ProjectImages.BIRD2_MID} width={40} />
//       </button>
//     </div>
...
function CanvasGame() {
  ...
  useEffect(() => {
    ...
    if (isGameover) {
      play();
      // Note: localStorage usage commented out for Claude.ai compatibility
       const item = localStorage.getItem("highScore") || "0";
       if (score && Number(item) < score)
         localStorage.setItem("highScore", JSON.stringify(score));
    }
  ...
  useEffect(() => {
    ...
    return () => cancelAnimationFrame(frameId);
  }, [isGameStarted, selectedBird]); // Added selectedBird to dependencies
      ...
      {!isGameStarted && (
        <div className="canvas-wrapper-start">
          <div className="start-canvas">
            ...
            <div className="bird-container">
              <img src={ProjectImages[`${selectedBird}_UP`]} alt="selected bird" />
            </div>
            <button onClick={() => setIsGameStarted(true)}>Start</button>
          </div>
          <div className="canvas-background" onClick={handleClick}>
          ...
          <div className="bird-selection">
            <h3>Select Bird</h3>
            <button 
              onClick={() => handleBirdSelection("BIRD1")}
              className={selectedBird === "BIRD1" ? "selected" : ""}
            >
              <img src={ProjectImages.BIRD1_MID} width={40} alt="Bird 1" />
            </button>
            <button 
              onClick={() => handleBirdSelection("BIRD2")}
              className={selectedBird === "BIRD2" ? "selected" : ""}
            >
              <img src={ProjectImages.BIRD2_MID} width={40} alt="Bird 2" />
            </button>
            <button 
              onClick={() => handleBirdSelection("BIRD3")}
              className={selectedBird === "BIRD3" ? "selected" : ""}
            >
              <img src={ProjectImages.BIRD3_MID} width={40} alt="Bird 3" />
            </button>
          </div>
          <div className="speed-btn-container">
          <button
